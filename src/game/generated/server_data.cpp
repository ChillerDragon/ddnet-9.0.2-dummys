...
static CDataImage x14[] = {
	...
	/* x14[9] */ {  "speedup_arrow",  "editor/speed_arrow.png",  -1, },
	/* x14[10] */ {  "demobuttons",  "demo_buttons.png",  -1, },
	/* x14[11] */ {  "fileicons",  "file_icons.png",  -1, },
	/* x14[12] */ {  "guibuttons",  "gui_buttons.png",  -1, },
	/* x14[13] */ {  "guiicons",  "gui_icons.png",  -1, },
	/* x14[14] */ {  "arrow",  "arrow.png",  -1, },
	/* x14[15] */ {  "demobuttons2",  "demo_buttons2.png",  -1, },
	/* x14[16] */ {  "audio_source",  "editor/audio_source.png",  -1, },
};
...
static CDataSprite x44[] = {
	...
	/* x44[92] */ {  "speedup_arrow",  &x28[5],  0,  0,  1,  1, },
	/* x44[93] */ {  "demobutton_play",  &x28[6],  0,  0,  1,  1, },
	/* x44[94] */ {  "demobutton_pause",  &x28[6],  1,  0,  1,  1, },
	/* x44[95] */ {  "demobutton_stop",  &x28[6],  2,  0,  1,  1, },
	/* x44[96] */ {  "demobutton_slower",  &x28[6],  3,  0,  1,  1, },
	/* x44[97] */ {  "demobutton_faster",  &x28[6],  4,  0,  1,  1, },
	/* x44[98] */ {  "demobutton_slice_begin",  &x28[10],  0,  0,  1,  1, },
	/* x44[99] */ {  "demobutton_slice_end",  &x28[10],  1,  0,  1,  1, },
	/* x44[100] */ {  "file_demo1",  &x28[7],  0,  0,  1,  1, },
	/* x44[101] */ {  "file_demo2",  &x28[7],  1,  0,  1,  1, },
	/* x44[102] */ {  "file_folder",  &x28[7],  2,  0,  1,  1, },
	/* x44[103] */ {  "file_map1",  &x28[7],  5,  0,  1,  1, },
	/* x44[104] */ {  "file_map2",  &x28[7],  6,  0,  1,  1, },
	/* x44[105] */ {  "guibutton_off",  &x28[8],  0,  0,  4,  4, },
	/* x44[106] */ {  "guibutton_on",  &x28[8],  4,  0,  4,  4, },
	/* x44[107] */ {  "guibutton_hover",  &x28[8],  8,  0,  4,  4, },
	/* x44[108] */ {  "guiicon_mute",  &x28[9],  0,  0,  4,  2, },
	/* x44[109] */ {  "guiicon_friend",  &x28[9],  4,  0,  4,  2, },
	/* x44[110] */ {  "audio_source",  &x28[11],  0,  0,  1,  1, },
};
static CAnimKeyframe x4376[] = {
	/* x4376[0] */ {  0.000000,  0.000000,  -4.000000,  0.000000, },
};
static CAnimKeyframe x4383[] = {
	/* x4383[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe x4390[] = {
	/* x4390[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe *x4397 = 0;
static CAnimKeyframe *x4421 = 0;
static CAnimKeyframe x4428[] = {
	/* x4428[0] */ {  0.000000,  -7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4435[] = {
	/* x4435[0] */ {  0.000000,  7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe *x4442 = 0;
static CAnimKeyframe *x4461 = 0;
static CAnimKeyframe x4468[] = {
	/* x4468[0] */ {  0.000000,  -3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe x4475[] = {
	/* x4475[0] */ {  0.000000,  3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4482 = 0;
static CAnimKeyframe x4501[] = {
	/* x4501[0] */ {  0.000000,  0.000000,  0.000000,  0.000000, },
	/* x4501[1] */ {  0.200000,  0.000000,  -1.000000,  0.000000, },
	/* x4501[2] */ {  0.400000,  0.000000,  0.000000,  0.000000, },
	/* x4501[3] */ {  0.600000,  0.000000,  0.000000,  0.000000, },
	/* x4501[4] */ {  0.800000,  0.000000,  -1.000000,  0.000000, },
	/* x4501[5] */ {  1.000000,  0.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4508[] = {
	/* x4508[0] */ {  0.000000,  8.000000,  0.000000,  0.000000, },
	/* x4508[1] */ {  0.200000,  -8.000000,  0.000000,  0.000000, },
	/* x4508[2] */ {  0.400000,  -10.000000,  -4.000000,  0.200000, },
	/* x4508[3] */ {  0.600000,  -8.000000,  -8.000000,  0.300000, },
	/* x4508[4] */ {  0.800000,  4.000000,  -4.000000,  -0.200000, },
	/* x4508[5] */ {  1.000000,  8.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4515[] = {
	/* x4515[0] */ {  0.000000,  -10.000000,  -4.000000,  0.200000, },
	/* x4515[1] */ {  0.200000,  -8.000000,  -8.000000,  0.300000, },
	/* x4515[2] */ {  0.400000,  4.000000,  -4.000000,  -0.200000, },
	/* x4515[3] */ {  0.600000,  8.000000,  0.000000,  0.000000, },
	/* x4515[4] */ {  0.800000,  8.000000,  0.000000,  0.000000, },
	/* x4515[5] */ {  1.000000,  -10.000000,  -4.000000,  0.200000, },
};
static CAnimKeyframe *x4522 = 0;
static CAnimKeyframe *x4621 = 0;
static CAnimKeyframe *x4628 = 0;
static CAnimKeyframe *x4635 = 0;
static CAnimKeyframe x4642[] = {
	/* x4642[0] */ {  0.000000,  0.000000,  0.000000,  -0.100000, },
	/* x4642[1] */ {  0.300000,  0.000000,  0.000000,  0.250000, },
	/* x4642[2] */ {  0.400000,  0.000000,  0.000000,  0.300000, },
	/* x4642[3] */ {  0.500000,  0.000000,  0.000000,  0.250000, },
	/* x4642[4] */ {  1.000000,  0.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4676 = 0;
static CAnimKeyframe *x4683 = 0;
static CAnimKeyframe *x4690 = 0;
static CAnimKeyframe x4697[] = {
	/* x4697[0] */ {  0.000000,  0.000000,  0.000000,  -0.250000, },
	/* x4697[1] */ {  0.100000,  0.000000,  0.000000,  -0.050000, },
	/* x4697[2] */ {  0.150000,  0.000000,  0.000000,  0.350000, },
	/* x4697[3] */ {  0.420000,  0.000000,  0.000000,  0.400000, },
	/* x4697[4] */ {  0.500000,  0.000000,  0.000000,  0.350000, },
	/* x4697[5] */ {  1.000000,  0.000000,  0.000000,  -0.250000, },
};
static CAnimation x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4376, },  /* x75[0].back_foot */ {  1,x4383, },  /* x75[0].front_foot */ {  1,x4390, },  /* x75[0].attach */ {  0,x4397, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4421, },  /* x75[1].back_foot */ {  1,x4428, },  /* x75[1].front_foot */ {  1,x4435, },  /* x75[1].attach */ {  0,x4442, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4461, },  /* x75[2].back_foot */ {  1,x4468, },  /* x75[2].front_foot */ {  1,x4475, },  /* x75[2].attach */ {  0,x4482, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4501, },  /* x75[3].back_foot */ {  6,x4508, },  /* x75[3].front_foot */ {  6,x4515, },  /* x75[3].attach */ {  0,x4522, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4621, },  /* x75[4].back_foot */ {  0,x4628, },  /* x75[4].front_foot */ {  0,x4635, },  /* x75[4].attach */ {  5,x4642, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4676, },  /* x75[5].back_foot */ {  0,x4683, },  /* x75[5].front_foot */ {  0,x4690, },  /* x75[5].attach */ {  6,x4697, }, },
};
static CDataSprite* *x4854 = 0;
static CDataSprite* x4991[] = {
	&x44[29],
	&x44[30],
	&x44[31],
};
static CDataSprite* x5176[] = {
	&x44[35],
	&x44[36],
	&x44[37],
};
static CDataSprite* *x5361 = 0;
static CDataSprite* *x5498 = 0;
static CDataSprite* x5635[] = {
	&x44[52],
	&x44[53],
	&x44[54],
};
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4854,  96,  125,  10,  0,  3,  4.000000,  -20.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x4991,  64,  125,  10,  500,  1,  32.000000,  4.000000,  50.000000,  6.000000,  5.000000, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5176,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  70.000000,  6.000000,  5.000000, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5361,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[4] */ {  "rifle",  &x44[47],  &x44[48],  &x44[49],  0,x5498,  92,  800,  10,  0,  5,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5635,  96,  800,  10,  0,  9,  0.000000,  0.000000,  40.000000,  -4.000000,  5.000000, },
};
